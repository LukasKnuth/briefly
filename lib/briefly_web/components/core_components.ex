defmodule BrieflyWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: BrieflyWeb.Gettext
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(BrieflyWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(BrieflyWeb.Gettext, "errors", msg, opts)
    end
  end
